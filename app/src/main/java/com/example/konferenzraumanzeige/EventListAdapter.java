...
/**
 * Creates the visual list that is displayed in the Calendar Fragment.
 */
...
public class EventListAdapter extends ArrayAdapter<Event> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
            ...
            holder.organizer.setText(Objects.requireNonNull(Objects.requireNonNull(event.organizer).emailAddress).name);
